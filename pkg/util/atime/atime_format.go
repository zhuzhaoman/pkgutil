...
var (
	...
	formats = map[byte]string{
		...
		'a': "pm",                        // Date:   Lowercase Ante meridiem and Post meridiem. Eg: am or pm.
		'A': "PM",                        // Date:   Uppercase Ante meridiem and Post meridiem. Eg: AM or PM.
		'g': "3",                         // Date:   12-hour format of an hour without leading zeros. Eg: 1 through 12.
		'G': "=G=15",                     // Date:   24-hour format of an hour without leading zeros. Eg: 0 through 23.
		'h': "03",                        // Date:   12-hour format of an hour with leading zeros. Eg: 01 through 12.
		'H': "15",                        // Date:   24-hour format of an hour with leading zeros. Eg: 00 through 23.
		'i': "04",                        // Date:   Minutes with leading zeros. Eg: 00 to 59.
		's': "05",                        // Date:   Seconds with leading zeros. Eg: 00 through 59.
		'u': "=u=.000",                   // Date:   Milliseconds. Eg: 234, 678.
		'U': "",                          // Date:   Seconds since the Unix Epoch (January 1 1970 00:00:00 GMT).
...
//// FormatNew formats and returns a new Date object with given custom `format`.
//func (t *Date) FormatNew(format string) *Date {
//	if t == nil {
//		return nil
//	}
...
//func (t *Date) FormatTo(format string) *Date {
//	if t == nil {
//		return nil
//	}
...
func (t *Date) Layout(layout string) string {
	if t == nil {
		return ""
	}
...
// Layout formats the time with stdlib layout and returns the formatted result.
func (t *DateTime) Layout(layout string) string {
	if t == nil {
		return ""
	}
	return t.Time.Format(layout)
...
//// LayoutNew formats the time with stdlib layout and returns the new Date object.
//func (t *Date) LayoutNew(layout string) *Date {
//	if t == nil {
//		return nil
//	}
...
//func (t *Date) LayoutTo(layout string) *Date {
//	if t == nil {
//		return nil
//	}
...
// DaysInMonth returns the day count of current month.
func (t *DateTime) DaysInMonth() int {
	switch t.Month() {
	case 1, 3, 5, 7, 8, 10, 12:
		return 31
	case 4, 6, 9, 11:
...
// WeeksOfYear returns the point of current week for the year.
func (t *DateTime) WeeksOfYear() int {
	_, week := t.ISOWeek()
	return week
}
